...
const studentPerformanceReport = async (req, res) => {
        ...
        if(existingReport.length === 0) {
            ...
            for (let i = 0; i < quizzes.length; i++) {
                ...
                result.push({
                    ...
                    scores: scores,
                    averageScore: avgscore[0]?.avg_score,
                    highestScore: highestScore[0]?.highest_score,
                    lowestScore: lowestScore[0]?.lowest_score,
                    avgDuration: avgDuration[0]?.avg_answer_time
                })
            }
...
const classEngagementReport = async (req, res) => {
...
const contentEffectivenessReport = async (req, res) => {
